import { $ as NoMatchingStaticPathFound, H as LocalsReassigned, L as InvalidGetStaticPathsEntry, M as GetStaticPathsInvalidRouteParam, N as GetStaticPathsRequired, R as InvalidGetStaticPathsReturn, U as MiddlewareNoDataOrNextCalled, V as LocalsNotAnObject, W as MiddlewareNotAResponse, _ as ActionNotFoundError, _t as AstroError, a as fileExtension, at as ReservedSlotName, b as CacheNotEnabled, ct as SessionStorageInitError, dt as UnableToLoadLogger, f as removeLeadingForwardSlash, g as trimSlashes, gt as i18nNoLocaleFoundInPath, h as slash, i as collapseDuplicateTrailingSlashes, j as GetStaticPathsExpectedParams, k as ForbiddenRewrite, l as joinPaths, lt as SessionStorageSaveError, m as removeTrailingForwardSlash, n as collapseDuplicateLeadingSlashes, nt as PrerenderClientAddressNotAvailable, o as hasFileExtension, ot as ResponseSentError, r as collapseDuplicateSlashes, rt as PrerenderDynamicEndpointPathCollide, s as isInternalPath, st as RewriteWithBodyUsed, t as appendForwardSlash, tt as PageNumberParamNotFound, u as prependForwardSlash, ut as StaticClientAddressNotAvailable, v as ActionsReturnedInvalidDataError, vt as AstroUserError, x as ClientAddressNotAvailable, y as AstroResponseHeadersReassigned } from "./chunks/path_BVS9cGLr.mjs";
import { c as matchPattern } from "./chunks/remoteProbe_D0BynBK3.mjs";
import { A as ASTRO_GENERATOR, D as isRoute404, F as clientAddressSymbol, I as fetchStateSymbol, L as originPathnameSymbol, M as REDIRECT_STATUS_CODES, N as REROUTABLE_STATUS_CODES, O as isRoute500, P as appSymbol, R as pipelineSymbol, S as createVNode, a as renderComponent, b as isAstroComponentFactory, c as createSlotValueFromString, d as isRenderTemplateResult, f as renderTemplate, h as generateCspDigest, i as renderJSX, j as DEFAULT_404_COMPONENT, k as ASTRO_ERROR_HEADER, m as decryptString, o as renderStreaming, p as decodeKey, r as renderPage, s as chunkToString, u as renderSlotToString, w as renderEndpoint, x as AstroJSX, y as isRenderInstruction, z as responseSentSymbol$1 } from "./chunks/server_CR6e1SMo.mjs";
...
var middlewareSecret = "919b2337-8d9b-4f86-814e-00d342e8eea8";
//#endregion
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"MODE": "production",
			"PROD": true,
			"PUBLIC_SUPABASE_ANON_KEY": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1jY3ptbHJraHRkb3N5cGZiYmZuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM1ODg0NTEsImV4cCI6MjA5OTE2NDQ1MX0.yADNzH5cgixsiGYytea5qXrnsgRsYOiYjy6jrysQ3LI",
			"PUBLIC_SUPABASE_URL": "https://mcczmlrkhtdosypfbbfn.supabase.co",
...
var renderers = [Object.assign({
	"name": "astro:jsx",
	"serverEntrypoint": "file:///D:/astro/GiftCorp/node_modules/@astrojs/mdx/dist/server.js"
}, { ssr: {
	name: "astro:jsx",
	check,
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/layanan/create.astro",
			"pathname": "/admin/layanan/create",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/admin/layanan/edit/[id]",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/admin\\/layanan\\/edit\\/([^/]+?)\\/?$",
			"segments": [
				[{
					"content": "admin",
					"dynamic": false,
			...
			"params": ["id"],
			"component": "src/pages/admin/layanan/edit/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/layanan/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/pesan/index.astro",
			"pathname": "/admin/pesan",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/admin/produk/create",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/admin\\/produk\\/create\\/?$",
			"segments": [
				[{
					"content": "admin",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/admin/produk/create.astro",
			"pathname": "/admin/produk/create",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/admin/produk/edit/[id]",
			"isIndex": false,
			"type": "page",
			"pattern": "^\\/admin\\/produk\\/edit\\/([^/]+?)\\/?$",
			"segments": [
				[{
					"content": "admin",
					"dynamic": false,
			...
			"params": ["id"],
			"component": "src/pages/admin/produk/edit/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/admin/produk/index.astro",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/submit-quote.ts",
			"pathname": "/api/submit-quote",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/produk/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/produk/index.astro",
			"pathname": "/produk",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_DvMb5S5v.mjs");
var _page1 = () => import("./chunks/404_BqyF8xzA.mjs");
var _page2 = () => import("./chunks/500_w9ydbJSi.mjs");
var _page3 = () => import("./chunks/about_Dnv47LkV.mjs");
var _page4 = () => import("./chunks/create_BGyfyr43.mjs");
var _page5 = () => import("./chunks/_id__BFvpw2i3.mjs");
var _page6 = () => import("./chunks/create_CxfArNiI.mjs");
var _page7 = () => import("./chunks/_id__Cv1HYhpL.mjs");
var _page8 = () => import("./chunks/index_kPTEFhzG.mjs");
var _page9 = () => import("./chunks/index_jWXu4Afn.mjs");
var _page10 = () => import("./chunks/create_BTijSo8F.mjs");
var _page11 = () => import("./chunks/_id__CvD0fkrp.mjs");
var _page12 = () => import("./chunks/index_tatJI8dy.mjs");
var _page13 = () => import("./chunks/index_C3pc7eoq.mjs");
var _page14 = () => import("./chunks/submit-quote_DoZ1mRki.mjs");
var _page15 = () => import("./chunks/index_Dse2mc1J.mjs");
var _page16 = () => import("./chunks/_.._Cl4Vutp5.mjs");
var _page17 = () => import("./chunks/contact_myEmI6Xg.mjs");
var _page18 = () => import("./chunks/faq_CPj4qpWq.mjs");
var _page19 = () => import("./chunks/privacy_D0jgIya-.mjs");
var _page20 = () => import("./chunks/_slug__t2_rheDa.mjs");
var _page21 = () => import("./chunks/index_BGg7Dxf4.mjs");
var _page22 = () => import("./chunks/rss_7S5IGiyl.mjs");
var _page23 = () => import("./chunks/index_C_LfMiFg.mjs");
var _page24 = () => import("./chunks/_.._C6CFyUp2.mjs");
var _page25 = () => import("./chunks/terms_DKRuZy_L.mjs");
var _page26 = () => import("./chunks/index_Cbl-C4Ea.mjs");
var pageMap = /* @__PURE__ */ new Map([
	...
	["src/pages/admin/layanan/create.astro", _page6],
	["src/pages/admin/layanan/edit/[id].astro", _page7],
	["src/pages/admin/layanan/index.astro", _page8],
	["src/pages/admin/pesan/index.astro", _page9],
	["src/pages/admin/produk/create.astro", _page10],
	["src/pages/admin/produk/edit/[id].astro", _page11],
	["src/pages/admin/produk/index.astro", _page12],
	["src/pages/admin/index.astro", _page13],
	["src/pages/api/submit-quote.ts", _page14],
	...
	["src/pages/produk/[slug].astro", _page20],
	["src/pages/produk/index.astro", _page21],
	["src/pages/rss.xml.js", _page22],
	["src/pages/services/index.astro", _page23],
	["src/pages/services/[...slug].astro", _page24],
	["src/pages/terms.astro", _page25],
	["src/pages/index.astro", _page26]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///D:/astro/GiftCorp/","cacheDir":"file:///D:/astro/GiftCorp/node_modules/.astro/","outDir":"file:///D:/astro/GiftCorp/dist/","srcDir":"file:///D:/astro/GiftCorp/src/","publicDir":"file:///D:/astro/GiftCorp/public/","buildClientDir":"file:///D:/astro/GiftCorp/dist/client/","buildServerDir":"file:///D:/astro/GiftCorp/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"h1[data-astro-cid-ibpinaeu]{font-size:10em;line-height:.8}\na[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/404","isIndex":false,"type":"page","pattern":"^\\/404\\/?$","segments":[[{"content":"404","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/404.astro","pathname":"/404","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"h1[data-astro-cid-qnkxrarz]{font-size:10em;line-height:.8}\na[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/500","isIndex":false,"type":"page","pattern":"^\\/500\\/?$","segments":[[{"content":"500","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/500.astro","pathname":"/500","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/about","isIndex":false,"type":"page","pattern":"^\\/about\\/?$","segments":[[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/about.astro","pathname":"/about","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/create","isIndex":false,"type":"page","pattern":"^\\/admin\\/create\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"create","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/create.astro","pathname":"/admin/create","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/edit/[id]","isIndex":false,"type":"page","pattern":"^\\/admin\\/edit\\/([^/]+?)\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"edit","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/admin/edit/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/layanan/create","isIndex":false,"type":"page","pattern":"^\\/admin\\/layanan\\/create\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"layanan","dynamic":false,"spread":false}],[{"content":"create","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/layanan/create.astro","pathname":"/admin/layanan/create","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/layanan/edit/[id]","isIndex":false,"type":"page","pattern":"^\\/admin\\/layanan\\/edit\\/([^/]+?)\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"layanan","dynamic":false,"spread":false}],[{"content":"edit","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/admin/layanan/edit/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/layanan","isIndex":true,"type":"page","pattern":"^\\/admin\\/layanan\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"layanan","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/layanan/index.astro","pathname":"/admin/layanan","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/pesan","isIndex":true,"type":"page","pattern":"^\\/admin\\/pesan\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"pesan","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/pesan/index.astro","pathname":"/admin/pesan","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/produk/create","isIndex":false,"type":"page","pattern":"^\\/admin\\/produk\\/create\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"produk","dynamic":false,"spread":false}],[{"content":"create","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/produk/create.astro","pathname":"/admin/produk/create","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/produk/edit/[id]","isIndex":false,"type":"page","pattern":"^\\/admin\\/produk\\/edit\\/([^/]+?)\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"produk","dynamic":false,"spread":false}],[{"content":"edit","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/admin/produk/edit/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin/produk","isIndex":true,"type":"page","pattern":"^\\/admin\\/produk\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}],[{"content":"produk","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/produk/index.astro","pathname":"/admin/produk","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"}],"routeData":{"route":"/admin","isIndex":true,"type":"page","pattern":"^\\/admin\\/?$","segments":[[{"content":"admin","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/admin/index.astro","pathname":"/admin","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/submit-quote","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/submit-quote\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"submit-quote","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/submit-quote.ts","pathname":"/api/submit-quote","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/blog","isIndex":true,"type":"page","pattern":"^\\/blog\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/blog/index.astro","pathname":"/blog","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/blog/[...slug]","isIndex":false,"type":"page","pattern":"^\\/blog(?:\\/(.*?))?\\/?$","segments":[[{"content":"blog","dynamic":false,"spread":false}],[{"content":"...slug","dynamic":true,"spread":true}]],"params":["...slug"],"component":"src/pages/blog/[...slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.astro","pathname":"/contact","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/faq","isIndex":false,"type":"page","pattern":"^\\/faq\\/?$","segments":[[{"content":"faq","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/faq.astro","pathname":"/faq","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/privacy","isIndex":false,"type":"page","pattern":"^\\/privacy\\/?$","segments":[[{"content":"privacy","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/privacy.astro","pathname":"/privacy","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/produk/[slug]","isIndex":false,"type":"page","pattern":"^\\/produk\\/([^/]+?)\\/?$","segments":[[{"content":"produk","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/produk/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/produk","isIndex":true,"type":"page","pattern":"^\\/produk\\/?$","segments":[[{"content":"produk","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/produk/index.astro","pathname":"/produk","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/rss.xml","isIndex":false,"type":"endpoint","pattern":"^\\/rss\\.xml$","segments":[[{"content":"rss.xml","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/rss.xml.js","pathname":"/rss.xml","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/services","isIndex":true,"type":"page","pattern":"^\\/services\\/?$","segments":[[{"content":"services","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/services/index.astro","pathname":"/services","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/services/[...slug]","isIndex":false,"type":"page","pattern":"^\\/services(?:\\/(.*?))?\\/?$","segments":[[{"content":"services","dynamic":false,"spread":false}],[{"content":"...slug","dynamic":true,"spread":true}]],"params":["...slug"],"component":"src/pages/services/[...slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/terms","isIndex":false,"type":"page","pattern":"^\\/terms\\/?$","segments":[[{"content":"terms","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/terms.astro","pathname":"/terms","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"external","src":"_astro/ThemeToggle.BW95muhZ.css"},{"type":"inline","content":"a[data-astro-cid-evkijfd6].active{color:var(--color-main-200);font-weight:bolder;text-decoration:underline}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","site":"https://heal-net-self.vercel.app/","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/astro/GiftCorp/src/pages/admin/create.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/edit/[id].astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/layanan/create.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/layanan/edit/[id].astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/layanan/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/pesan/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/produk/create.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/produk/edit/[id].astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/admin/produk/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/blog/[...slug].astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/404.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/500.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/about.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/blog/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/contact.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/faq.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/privacy.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/produk/[slug].astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/produk/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/services/[...slug].astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/services/index.astro",{"propagation":"none","containsHead":true}],["D:/astro/GiftCorp/src/pages/terms.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.CKBA3uyg.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/404@_@astro":"chunks/404_BqyF8xzA.mjs","\u0000virtual:astro:page:src/pages/500@_@astro":"chunks/500_w9ydbJSi.mjs","\u0000virtual:astro:page:src/pages/services/[...slug]@_@astro":"chunks/_.._C6CFyUp2.mjs","\u0000virtual:astro:page:src/pages/blog/[...slug]@_@astro":"chunks/_.._Cl4Vutp5.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_APSZSf_0.mjs","\u0000virtual:astro:page:src/pages/admin/edit/[id]@_@astro":"chunks/_id__BFvpw2i3.mjs","\u0000virtual:astro:page:src/pages/admin/layanan/edit/[id]@_@astro":"chunks/_id__Cv1HYhpL.mjs","\u0000virtual:astro:page:src/pages/admin/produk/edit/[id]@_@astro":"chunks/_id__CvD0fkrp.mjs","\u0000virtual:astro:page:src/pages/produk/[slug]@_@astro":"chunks/_slug__t2_rheDa.mjs","\u0000virtual:astro:page:src/pages/about@_@astro":"chunks/about_Dnv47LkV.mjs","\u0000virtual:astro:page:src/pages/contact@_@astro":"chunks/contact_myEmI6Xg.mjs","D:\\astro\\GiftCorp\\.astro\\content-assets.mjs":"chunks/content-assets_u1KK2p_z.mjs","\u0000virtual:astro:page:src/pages/admin/create@_@astro":"chunks/create_BGyfyr43.mjs","\u0000virtual:astro:page:src/pages/admin/produk/create@_@astro":"chunks/create_BTijSo8F.mjs","\u0000virtual:astro:page:src/pages/admin/layanan/create@_@astro":"chunks/create_CxfArNiI.mjs","\u0000virtual:astro:page:src/pages/faq@_@astro":"chunks/faq_CPj4qpWq.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_DvMb5S5v.mjs","\u0000virtual:astro:page:src/pages/produk/index@_@astro":"chunks/index_BGg7Dxf4.mjs","\u0000virtual:astro:page:src/pages/admin/index@_@astro":"chunks/index_C3pc7eoq.mjs","\u0000virtual:astro:page:src/pages/services/index@_@astro":"chunks/index_C_LfMiFg.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_Cbl-C4Ea.mjs","\u0000virtual:astro:page:src/pages/blog/index@_@astro":"chunks/index_Dse2mc1J.mjs","\u0000virtual:astro:page:src/pages/admin/pesan/index@_@astro":"chunks/index_jWXu4Afn.mjs","\u0000virtual:astro:page:src/pages/admin/layanan/index@_@astro":"chunks/index_kPTEFhzG.mjs","\u0000virtual:astro:page:src/pages/admin/produk/index@_@astro":"chunks/index_tatJI8dy.mjs","\u0000virtual:astro:page:src/pages/privacy@_@astro":"chunks/privacy_D0jgIya-.mjs","\u0000virtual:astro:page:src/pages/rss.xml@_@js":"chunks/rss_7S5IGiyl.mjs","D:/astro/GiftCorp/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_CQXUulS9.mjs","\u0000virtual:astro:page:src/pages/api/submit-quote@_@ts":"chunks/submit-quote_DoZ1mRki.mjs","\u0000virtual:astro:page:src/pages/terms@_@astro":"chunks/terms_DKRuZy_L.mjs","D:/astro/GiftCorp/src/components/homepage/CtaForm.astro?astro&type=script&index=0&lang.ts":"_astro/CtaForm.astro_astro_type_script_index_0_lang.CkILCFLc.js","D:/astro/GiftCorp/src/components/homepage/Support.astro?astro&type=script&index=0&lang.ts":"_astro/Support.astro_astro_type_script_index_0_lang.DiwG-uug.js","D:/astro/GiftCorp/src/components/ThemeToggle.astro?astro&type=script&index=0&lang.ts":"_astro/ThemeToggle.astro_astro_type_script_index_0_lang.7KayjY2F.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/astro/GiftCorp/src/components/homepage/CtaForm.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`wa-cta-form`);e&&e.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`cta-email`),n=document.getElementById(`cta-phone`),r=document.getElementById(`cta-quantity`),i=`Halo GiftCorp, saya ingin meminta penawaran khusus.\\n\\nDetail:\\n- Email: ${t?.value||``}\\n- No. Telepon: ${n?.value||``}\\n- Estimasi Jumlah: ${r?.value||``} pcs\\n\\nMohon informasi lebih lanjut. Terima kasih!`,a=`https://wa.me/6281234567890?text=${encodeURIComponent(i)}`;window.open(a,`_blank`)})});"],["D:/astro/GiftCorp/src/components/homepage/Support.astro?astro&type=script&index=0&lang.ts","document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`wa-support-form`);e&&e.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`wa-name`),n=document.getElementById(`wa-email`),r=`Halo GiftCorp, perkenalkan saya ${t?.value||``} (${n?.value||``}). Saya ingin bertanya tentang produk dan penawaran khusus Anda.`,i=`https://wa.me/6281234567890?text=${encodeURIComponent(r)}`;window.open(i,`_blank`)})});"],["D:/astro/GiftCorp/src/components/ThemeToggle.astro?astro&type=script&index=0&lang.ts","function e(){let e=()=>{let e=document.documentElement,t=e.getAttribute(`data-theme`)===`dark`||e.classList.contains(`dark`)?`light`:`dark`;e.setAttribute(`data-theme`,t),t===`dark`?e.classList.add(`dark`):e.classList.remove(`dark`),localStorage.setItem(`theme`,t)};document.querySelectorAll(`button[aria-label=\"Toggle Theme\"]`).forEach(t=>{t.removeEventListener(`click`,e),t.addEventListener(`click`,e)})}e(),document.addEventListener(`astro:page-load`,e);"]],"assets":["/favicon/apple-touch-icon.png","/favicon/favicon-144x144.png","/favicon/favicon-96x96.png","/favicon/favicon.ico","/favicon/favicon.svg","/favicon/site.webmanifest","/favicon/web-app-manifest-192x192.png","/favicon/web-app-manifest-512x512.png","/img/avatars.png","/img/avatars.webp","/img/brands.png","/img/brands.webp","/img/cm1.webp","/img/cm2.webp","/img/hero.png","/img/img1.png","/img/img1.webp","/img/img2.jpg","/img/img2.webp","/img/img3.png","/img/img3.webp","/img/logo.svg","/img/logo2.svg","/img/stars.svg","/SEO/1.png","/SEO/2.png","/SEO/3.png","/SEO/4.png","/SEO/5.png","/SEO/og_1200x630.jpg","/SEO/screen1.jpg","/SEO/screen2.jpg","/SEO/screen3.jpg","/SEO/screen4.jpg","/uploads/1783262294692-Gemini_Generated_Image_48eqxt48eqxt48eq.png","/uploads/1783598977490-lima-souvenir-kantor-terbaik.webp","/uploads/1783599300573-lima-souvenir-kantor-terbaik.webp","/uploads/1783599579850-dua-produk.webp","/uploads/1783600028501-Hero2.webp","/uploads/1783680370930-Hero1.webp","/img/cmnts/ava1.webp","/img/cmnts/ava2.webp","/img/cmnts/ava3.webp","/img/cmnts/ava4.webp","/img/icons/i1.svg","/img/icons/i2.svg","/img/icons/i3.svg","/img/icons/i4.svg","/img/icons/i5.svg","/img/icons/quote.svg","/img/icons/soc1.svg","/img/icons/soc2.svg","/img/icons/soc3.svg","/img/icons/soc4.svg","/img/icons/star.svg","/img/shape/line1.svg","/img/shape/shape1.svg","/img/shape/shape2-1.svg","/img/shape/shape2.svg","/img/shape/shape3.svg","/img/shape/shape4.svg","/img/shape/shape5.svg","/img/shape/shape6.svg","/uploads/produk/1783264893085-ChatGPT_Image_26_Jun_2026__20.58.57.webp","/uploads/produk/1783600643673-baju_polo.webp","/uploads/produk/1783600882495-totebag.webp","/uploads/produk/1783600996812-notebook.webp","/uploads/produk/1783601195084-TOPI.webp","/uploads/produk/1783679667998-pulpen.webp","/uploads/services/1783269051690-About__1_.webp","/uploads/services/1783314710967-layanan-dua.webp","/uploads/services/1783613621888-About__1_.webp","/uploads/services/1783615039715-Hero3.webp","/_astro/fonts/1838c771a611e4c7.woff","/_astro/fonts/8fa1afb636ae3a94.woff","/_astro/og_1200x630.DJWwdq91.jpg","/_astro/blog-placeholder-2.BvXp4Pla.jpg","/_astro/s1.Dg3eny2R.jpg","/_astro/s6.tpZ4T8WH.jpg","/_astro/s2.uMwjuPil.jpg","/_astro/blog-placeholder-3.CFU5a9AV.jpg","/_astro/blog-placeholder-4.Cll70n_u.jpg","/_astro/s3.C8HrNEWV.jpg","/_astro/s5.BWaN-JT1.jpg","/_astro/ThemeToggle.BW95muhZ.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"HrTT+YNdNtl3QyyimLCqIUDLYWbPhAzyPZtH35Pr3AU=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
