import { B as LocalImageUsedWrongly, C as ExpectedImage, D as FontFamilyNotFound, F as IncompatibleDescriptorOptions, G as MissingGetFontFileRequestUrl, K as MissingImageDimension, P as ImageMissingAlt, T as ExpectedNotESMImage, _t as AstroError, c as isRemotePath, ht as UnsupportedImageFormat, it as RemoteImageNotAllowed, l as joinPaths, mt as UnsupportedImageConversion, p as removeQueryString, w as ExpectedImageOptions, z as InvalidImageService } from "./path_BVS9cGLr.mjs";
import { a as isRemoteImage, i as isESMImportedImage, o as resolveSrc, s as isRemoteAllowed, t as inferRemoteSize$1 } from "./remoteProbe_D0BynBK3.mjs";
import { C as unescapeHTML, E as createComponent, T as createAstro, f as renderTemplate, g as maybeRenderHead, t as spreadAttributes, v as addAttribute } from "./server_CR6e1SMo.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_CQXUulS9.mjs").catch((e) => {
...
}, "D:/astro/GiftCorp/node_modules/astro/components/Image.astro", void 0);
//#endregion
...
}, "D:/astro/GiftCorp/node_modules/astro/components/Picture.astro", void 0);
//#endregion
...
var componentDataByCssVariable = /* @__PURE__ */ new Map([["--font-atkinson", {
	"preloads": [{
		"style": "normal",
		"type": "woff",
		"url": "/_astro/fonts/8fa1afb636ae3a94.woff",
		"weight": "400"
	}, {
		"style": "normal",
		"type": "woff",
		"url": "/_astro/fonts/1838c771a611e4c7.woff",
		"weight": "700"
	}],
	"css": "@font-face{font-family:Atkinson-c7f4c4e8b285552f;src:url(\"/_astro/fonts/8fa1afb636ae3a94.woff\") format(\"woff\");font-display:swap;font-weight:400;font-style:normal;}@font-face{font-family:Atkinson-c7f4c4e8b285552f;src:url(\"/_astro/fonts/1838c771a611e4c7.woff\") format(\"woff\");font-display:swap;font-weight:700;font-style:normal;}@font-face{font-family:\"Atkinson-c7f4c4e8b285552f fallback: Arial\";src:local(\"Arial\");font-display:swap;font-weight:400;font-style:normal;size-adjust:99.3717%;ascent-override:80.1033%;descent-override:25.2587%;line-gap-override:0%;}@font-face{font-family:\"Atkinson-c7f4c4e8b285552f fallback: Arial Bold\";src:local(\"Arial Bold\");font-display:swap;font-weight:700;font-style:normal;size-adjust:92.2954%;ascent-override:86.2448%;descent-override:27.1953%;line-gap-override:0%;}:root{--font-atkinson:Atkinson-c7f4c4e8b285552f,\"Atkinson-c7f4c4e8b285552f fallback: Arial\",\"Atkinson-c7f4c4e8b285552f fallback: Arial Bold\",sans-serif;}"
}]]);
//#endregion
...
}, "D:/astro/GiftCorp/node_modules/astro/components/Font.astro", void 0);
//#endregion
...
new SsrRuntimeFontFileUrlResolver({ urls: /* @__PURE__ */ new Set(["/_astro/fonts/8fa1afb636ae3a94.woff", "/_astro/fonts/1838c771a611e4c7.woff"]) });
(function() {
	const regexes = [
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.env)$/i,
		/^(?:(?:^|\/|(?:(?:(?!(?:^|\/)\.{1,2}(?:\/|$)).)*?)\/)\.env\.[^/]*?\/?)$/i,
...
//#endregion
export { baseService as a, getConfiguredImageService as i, $$Font as n, parseQuality as o, $$Image as r, resolveDefaultOutputFormat as s, imageConfig as t };
