...
var $$Component = createComponent(async ($$result, $$props, $$slots) => {
	...
	try {
		const { data, error } = await db.from("posts").select("*").neq("id", postData.id).order("created_at", { ascending: false }).limit(3);
