...
import { r as createLucideIcon_default } from "./ThemeToggle_C37eLmi3.mjs";
...
import { n as $$Team, r as Phone, t as $$Story } from "./Story_Dvdk0Cbz.mjs";
...
var $$Hero = createComponent(($$result, $$props, $$slots) => {
	...
	})}<!-- Floating Badge 1 (Klien Puas) --><div class="absolute right-0 sm:-right-6 top-10 border-main-200 border rounded-lg p-2.5 bg-white/90 backdrop-blur shadow-lg max-w-[140px] sm:max-w-[160px]"><div class="flex flex-wrap gap-1.5 items-center mb-1">${renderComponent($$result, "Image", $$Image, {
