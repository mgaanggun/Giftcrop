...
//#endregion
export { NoMatchingStaticPathFound as $, GetEntryDeprecationError as A, LocalImageUsedWrongly as B, ExpectedImage as C, FontFamilyNotFound as D, FailedToFetchRemoteImageDimensions as E, IncompatibleDescriptorOptions as F, MissingGetFontFileRequestUrl as G, LocalsReassigned as H, InvalidComponentArgs as I, MissingSharp as J, MissingImageDimension as K, InvalidGetStaticPathsEntry as L, GetStaticPathsInvalidRouteParam as M, GetStaticPathsRequired as N, FontFileUrlNotFound as O, ImageMissingAlt as P, NoMatchingRenderer as Q, InvalidGetStaticPathsReturn as R, EndpointDidNotReturnAResponse as S, ExpectedNotESMImage as T, MiddlewareNoDataOrNextCalled as U, LocalsNotAnObject as V, MiddlewareNotAResponse as W, NoImageMetadata as X, NoClientOnlyHint as Y, NoMatchingImport as Z, ActionNotFoundError as _, AstroError as _t, fileExtension as a, ReservedSlotName as at, CacheNotEnabled as b, isRemotePath as c, SessionStorageInitError as ct, removeBase as d, UnableToLoadLogger as dt, OnlyResponseCanBeReturned as et, removeLeadingForwardSlash as f, UnavailableAstroGlobal as ft, trimSlashes as g, i18nNoLocaleFoundInPath as gt, slash as h, UnsupportedImageFormat as ht, collapseDuplicateTrailingSlashes as i, RemoteImageNotAllowed as it, GetStaticPathsExpectedParams as j, ForbiddenRewrite as k, joinPaths as l, SessionStorageSaveError as lt, removeTrailingForwardSlash as m, UnsupportedImageConversion as mt, collapseDuplicateLeadingSlashes as n, PrerenderClientAddressNotAvailable as nt, hasFileExtension as o, ResponseSentError as ot, removeQueryString as p, UnknownContentCollectionError as pt, MissingMediaQueryDirective as q, collapseDuplicateSlashes as r, PrerenderDynamicEndpointPathCollide as rt, isInternalPath as s, RewriteWithBodyUsed as st, appendForwardSlash as t, PageNumberParamNotFound as tt, prependForwardSlash as u, StaticClientAddressNotAvailable as ut, ActionsReturnedInvalidDataError as v, AstroUserError as vt, ExpectedImageOptions as w, ClientAddressNotAvailable as x, AstroResponseHeadersReassigned as y, InvalidImageService as z };
