...
//#region src/pages/admin/produk/create.astro
...
var $$Create = createComponent(async ($$result, $$props, $$slots) => {
	...
	if (Astro.request.method === "POST") try {
		...
		if (!name || !slug || !price) error = "Nama, Slug, dan Harga wajib diisi.";
			...
			const { error: insertError } = await db_default.from("products").insert([{
				name,
				slug,
				description,
				price: parsedPrice,
